...
export class LocationComponent  { 
    ...
    edit() : void {
        ...
        {
            this.location = new Location(this.location.getLocalLocation().zone, parseFloat(this.editEasting), parseFloat(this.editNorthing)).getLocation(this.location.zone);
        }
    }
}