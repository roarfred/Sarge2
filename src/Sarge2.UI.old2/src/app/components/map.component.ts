...
export class MapComponent {
    ...
    @Output() radiusR25Change = new EventEmitter();
    @Output() radiusR50Change = new EventEmitter();
    @Output() lockIppChange = new EventEmitter();
    @Output() ippChange = new EventEmitter();
    ...
    createMap(): void {
        ...
        this.map.on('postrender', (event: any) => {
            ...
            this.drawCrossHair();
            this.drawRadius();
            this.mapLocation = this.getLocation();
        });
